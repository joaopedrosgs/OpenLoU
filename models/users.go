...
type User struct {
	...
	Diamonds     int         `boil:"diamonds" json:"diamonds" toml:"diamonds" yaml:"diamonds"`
	Darkwood     int         `boil:"darkwood" json:"darkwood" toml:"darkwood" yaml:"darkwood"`
	Runestone    int         `boil:"runestone" json:"runestone" toml:"runestone" yaml:"runestone"`
	Veritium     int         `boil:"veritium" json:"veritium" toml:"veritium" yaml:"veritium"`
	Trueseed     int         `boil:"trueseed" json:"trueseed" toml:"trueseed" yaml:"trueseed"`
	Rank         int         `boil:"rank" json:"rank" toml:"rank" yaml:"rank"`
	AllianceName null.String `boil:"alliance_name" json:"alliance_name,omitempty" toml:"alliance_name" yaml:"alliance_name,omitempty"`
	AllianceRank null.String `boil:"alliance_rank" json:"alliance_rank,omitempty" toml:"alliance_rank" yaml:"alliance_rank,omitempty"`
...
var (
	userColumns               = []string{"created_at", "updated_at", "name", "email", "password", "gold", "diamonds", "darkwood", "runestone", "veritium", "trueseed", "rank", "alliance_name", "alliance_rank"}
	userColumnsWithoutDefault = []string{"name", "email", "password", "alliance_name", "alliance_rank"}
	userColumnsWithDefault    = []string{"created_at", "updated_at", "gold", "diamonds", "darkwood", "runestone", "veritium", "trueseed", "rank"}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, email string) (bool, error) {
	...
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, sql)
		fmt.Fprintln(boil.DebugWriter, email)
	}
